...
public class BreadthFirstSearch : AbstractPathfinding
{
    ...
    public virtual bool TryFindPath(BlockCtrl startBlock, BlockCtrl targetBlock)
    {
        ...
        while (this.queue.Count > 0)
        {
            ...
            foreach (Node neighbor in current.Neighbors())
            {
                ...
                // hướng đã đi qua, loại
                if (this.visited.Contains(neighbor)) continue;
                // không là vị trí hợp lệ, loại
                ...
                // rẽ quá 3 lần là đường đi không hợp lệ
                if (nodeStep.changeDirectionCount > 3) continue;

                // vẫn đi được thì nối thêm vào
    ...
    // kiểm tra node hiện tại có phải node đích không
